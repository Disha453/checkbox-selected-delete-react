...
const Hello = () => {
  ...
  const deletbox = () => {
    const filterdata = data.filter((item) => !langg.includes(item.uname))
    setData(filterdata);
    localStorage.setItem("h", JSON.stringify(filterdata));
  }
  ...
  return (
    ...
    <div style={{ backgroundImage: 'url(https://img.freepik.com/premium-photo/abstract-background-images-wallpaper-ai-generated_643360-60993.jpg)', padding: "20%", backgroundSize: "cover" }}>
      <div style={{ display: 'flex', flexDirection: "column", alignItems: "center" }}>
        ...
        <button type='submit' onClick={deletbox} style={{ marginTop: "5%", backgroundColor: "transparent", height: "40px", width: "90px", borderRadius: "8px", color: "#1b47cf", boxShadow: "-5px -5px 5px #7a8ec4 inset" }}><b>Delete</b></button>
      </div>
